...
<html>
  <head>
    ...
    function eliminar()
    {
    	...
    	var flag = confirm("¿Está seguro de eliminar su cuenta?\nTu cuenta y tu información serán borradas de XYZ.");
...
<script type="text/javascript">
        ...
        <h5>Perfil <i class="fa fa-user"></i> <a href="PrincipalMenu.jsp">Volver <i class="fa fa-undo"></i></a></h5>
        <span> <a href="javascript:guardar()">Guardar <i class="fa fa-save"></i></a> | <a href="javascript:eliminar()">Eliminar <i class="fa fa-trash"></i></a></span>
        
        <form action="./control" method="post">
        <input type="hidden" value="" id="accion" name="accion">
        <input type="hidden" name="correo" value="<%=usuario.getEmail() %>" class="form-control"  id="correo" >
        <fieldset>
        <label><i class="fa fa-info-circle"></i> Nombres:</label>
        <input type="text" name="nombre" value="<%=usuario.getNombre() %>" id="nombre" class="form-control" >
        </fieldset>
        <fieldset>
        ...
        <fieldset>
        <label> NIT:</label>
        <input type="text" name="nit" value="<%=usuario.getNit() %>" class="form-control" >
        </fieldset>
        <fieldset>
